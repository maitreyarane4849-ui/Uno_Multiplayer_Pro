...
* Dynamically generates the frontend (HTML, CSS, JavaScript)
* Starts a local HTTP server
* Opens the game automatically in the browser

The game supports **single-player mode with AI bot** and **local multiplayer**.
...
* **HTTP Server & Sockets** – Runtime hosting
...
* Creating rule-based AI decision logic
* Integrating Python with frontend technologies
* Enhancing user experience with animations and sound
* Structuring code for scalability and future features
